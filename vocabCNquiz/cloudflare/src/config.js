...
export function getConfig(env) {
  return {
    ...
    githubIdeationWorkflow: env.GITHUB_IDEATION_WORKFLOW_FILE || env.GITHUB_IDEATION_WORKFLOW || "vocabcn_ideation.yml",
    githubQcWorkflow: env.GITHUB_QC_WORKFLOW_FILE || env.GITHUB_QC_WORKFLOW || "vocabcn_qc.yml",
