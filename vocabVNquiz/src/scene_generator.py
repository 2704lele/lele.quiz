...
class {scene_name}(Scene):
    def construct(self):
        ...
        if os.path.exists(logo_path):
            ...
            logo_img = Dot(radius=0.45, color=YELLOW_E).move_to(footer_card.get_left() + RIGHT * 0.8)
        ...
        for idx, w in enumerate(words, start=1):
            ...
            # 1. Question Hero: Nghĩa Tiếng Việt to rõ
            vn_text = Text(
                meaning,
                font=VIETNAMESE_FONT,
                font_size=88,
            ...
            # 2. Vùng placeholder chờ dịch Tiếng Việt ➔ Tiếng Trung
            prompt_box = RoundedRectangle(
                ...
                stroke_color="#f59e0b",
                stroke_width=1.2
            ).next_to(vn_text, DOWN, buff=0.45)
            prompt_text = Text(
                "❓ Tiếng Trung là gì?",
                font=VIETNAMESE_FONT,
                font_size=40,
            ...
            quiz_mobjects = VGroup(vn_text, prompt_group, timer_group, bar_track, active_bar)
            ...
            ans_pinyin = Text(
                ...
                color=WHITE,
                weight=BOLD
            ).next_to(ans_hanzi, DOWN, buff=0.25)
