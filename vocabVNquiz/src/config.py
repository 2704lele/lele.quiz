...
class AppConfig:
    ...
    quiz_type: str = "vocabVN"  # Vietnamese Question -> Guess Chinese Answer

    # Spreadsheet Settings
    spreadsheet_id: str = "1b6LNl7JHRiCsjK1w9VuD86GLqAfmSOtDUOm5whrGdH0"
    sheet_tab_name: str = "vocabVN"

    # Shared Google Drive target folder
    gdrive_target_folder: str = "1VPqs9h4LLmmmXWKDGWoAz1fUCylVLK2H"
    gdrive_subfolder: str = "vocabVNquiz"
    ...
    # Visual Theme - Neon Amber Gold
    theme_primary_color: str = "#f59e0b"    # Amber 500
    theme_accent_color: str = "#fbbf24"     # Amber 400
    theme_card_bg: str = "#0b0f19"
    theme_hook_text: str = "TÌM TỪ TRONG 5S"
