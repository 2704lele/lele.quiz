/**
 * LeLe Chinese Quiz - Ultra-Lightweight Edge Gateway & Router (Vocab VN Quiz)
...
export default {
  async fetch(req, env, ctx) {
    ...
    if (method === "GET" && url.pathname === "/") {
      return json({ project: "LeLe VocabVN Quiz Edge Router", pipeline: config.sheetTabName, status: "Online", architecture: "Ultra-Lightweight Async Dispatch (< 2ms)", timestamp: new Date().toISOString() });
    }
