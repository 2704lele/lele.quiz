/**
 * Configuration manager for VocabVNQuiz Cloudflare Worker
 */
...
export function getConfig(env) {
  return {
    ...
    sheetTabName: env.SHEET_TAB_NAME || "vocabVN",

    // Account & AI Gateway
    accountId: env.ACCOUNT_ID || "3591f5b61af3263ca14af7a1765cc954",
    aiGatewayName: env.AI_GATEWAY_NAME || "lelevocabvnquiz",
    ...
    githubWorkflowFile: env.GITHUB_WORKFLOW_FILE || "vocabvn_render.yml",
    githubIdeationWorkflow: env.GITHUB_IDEATION_WORKFLOW_FILE || env.GITHUB_IDEATION_WORKFLOW || "vocabvn_ideation.yml",
    githubQcWorkflow: env.GITHUB_QC_WORKFLOW_FILE || env.GITHUB_QC_WORKFLOW || "vocabvn_qc.yml",
    githubToken: env.GITHUB_TOKEN || "",
    cfWebhookUrl: env.CF_WEBHOOK_URL || "https://lele-vocabvnquiz.hothihuong113.workers.dev/api/receive-ideas",
