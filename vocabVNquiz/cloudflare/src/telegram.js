/**
 * Telegram Bot API Client & Webhook Command Handler for VocabVNQuiz
 */
  ...
  if (update.message && update.message.text) {
    ...
    if (text === "/status") {
      await sendTelegramMessage(
        botToken,
        chatId,
        `📊 <b>[Trạng Thái Pipeline: ${config.sheetTabName || "vocabVN"}]</b>\n\n` +
 ...
 */
export function getHelpMessage(tabName = "vocabVN") {
